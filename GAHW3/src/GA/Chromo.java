...
*******************************************************************************/
	...
	public static int selectParent(){
		...
		case 2:     //  Tournament Selection - Added by Chathika Feb-02
			
			double pFitterWins = 0.8;
			int contestant1 = Search.r.nextInt(Parameters.popSize-1);
			int contestant2 = contestant1 + 1;
			if(contestant2 == Parameters.popSize) {
				contestant2 = 0;
			}
			
			double tournamentOutcome = Search.r.nextDouble();
			
			if(tournamentOutcome > pFitterWins) {
				j = Search.member[contestant1].rawFitness < Search.member[contestant2].rawFitness ? 
		...
		case 4:     //	Rank Selection - Added by Chathika Feb-02
			randnum = Search.r.nextDouble();
            for (j=0; j<Parameters.popSize; j++){
